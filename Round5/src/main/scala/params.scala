object params {
    ...
    lazy val d = security_level match{
        ...
        case "R5N1_1_PKE_0d" => 636
        case "R5N1_3_PKE_0d" => 876
        case "R5N1_5_PKE_0d" => 1217
        case _ => 0
    ...
    lazy val n = security_level match{
        ...
        case "R5ND_3_KEM_0d" => 768
        case "R5ND_5_KEM_0d" => 1018
        case "R5N1_1_PKE_0d" => 1
        case "R5N1_3_PKE_0d" => 1
        case "R5N1_5_PKE_0d" => 1
        case _ => 0
    } //ring based if > 1
    lazy val h = security_level match{
        ...
        case "R5N1_1_PKE_0d" => 114
        case "R5N1_3_PKE_0d" => 446
        case "R5N1_5_PKE_0d" => 462
        case _ => 0
    ...
    lazy val q_bits = security_level match{
        ...
        case "R5N1_1_PKE_0d" => 12
        case "R5N1_3_PKE_0d" => 15
        case "R5N1_5_PKE_0d" => 15
        case _ => 0
    }
    ...
    lazy val p_bits = security_level match{
        ...
        case "R5N1_1_PKE_0d" => 9
        case "R5N1_3_PKE_0d" => 11
        case "R5N1_5_PKE_0d" => 12
        case _ => 0
    }
    ...
    lazy val t_bits = security_level match{
        ...
        case "R5N1_1_PKE_0d" => 6
        case "R5N1_3_PKE_0d" => 7
        case "R5N1_5_PKE_0d" => 9
        case _ => 0
    }
    ...
    lazy val b_bits: Int  = security_level match{
        ...
        case "R5N1_1_PKE_0d" => 2
        case "R5N1_3_PKE_0d" => 3
        case "R5N1_5_PKE_0d" => 4
        case _ => 0
    }
    ...
    lazy val n_bar = security_level match{
        ...
        case "R5ND_3_KEM_0d" => 1
        case "R5ND_5_KEM_0d" => 1
        case "R5N1_1_PKE_0d" => 8
        case "R5N1_3_PKE_0d" => 8
        case "R5N1_5_PKE_0d" => 8
    ...
    lazy val f = security_level match{
        ...
        case "R5N1_1_PKE_0d" => 0
        case "R5N1_3_PKE_0d" => 0
        case "R5N1_5_PKE_0d" => 0
        case _ => 0
    }
    ...
    lazy val kappa = security_level match{
        ...
        case "R5N1_1_PKE_0d" => 128
        case "R5N1_3_PKE_0d" => 192
        case "R5N1_5_PKE_0d" => 264
        case _ => 0
    }
    ...
    lazy val mu = security_level match{
        ...
        case "R5N1_1_PKE_0d" => 64
        case "R5N1_3_PKE_0d" => 64
        case "R5N1_5_PKE_0d" => 64
        case _ => 0
    }
